 ...
 */
class Squad extends \AddressBookBundle\Entity\Squad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AddressBookBundle\\Entity\\Squad' . "\0" . 'persons', '' . "\0" . 'AddressBookBundle\\Entity\\Squad' . "\0" . 'id', '' . "\0" . 'AddressBookBundle\\Entity\\Squad' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Squad $proxy) {
