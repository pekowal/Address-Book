 ...
 */
class Email extends \AddressBookBundle\Entity\Email implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'personId', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'id', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'email', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'type');
        }
