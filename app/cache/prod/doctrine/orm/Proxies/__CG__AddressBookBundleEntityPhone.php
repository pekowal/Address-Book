 ...
 */
class Phone extends \AddressBookBundle\Entity\Phone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AddressBookBundle\\Entity\\Phone' . "\0" . 'personId', '' . "\0" . 'AddressBookBundle\\Entity\\Phone' . "\0" . 'id', '' . "\0" . 'AddressBookBundle\\Entity\\Phone' . "\0" . 'number', '' . "\0" . 'AddressBookBundle\\Entity\\Phone' . "\0" . 'type');
        }
